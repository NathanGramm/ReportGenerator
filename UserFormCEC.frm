...
Private Sub GenerateReport_Click()
    ...
    For Each ws In controlFile.Worksheets
        ...
        ElseIf ws.Name = "Glossary" Then
            foundGlossary = True
        ElseIf ws.Name = "CEC " + sheetName + " Report" Then
        ...
        If ws.UsedRange.Address = "$A$1" And ws.Range("A1") = "" And ws.Name <> "Cover Page" And ws.Name <> "Glossary" Then
            ...
            For j = 1 To controlFile.Worksheets.Count
                If controlFile.Worksheets(j).Name = "CEC " + sheetName + " Report" Then
                    foundDuplicateReport = True
                    Exit For
                End If
            Next j
            If Not foundDuplicateReport Then
                ws.Name = "CEC " + sheetName + " Report"
            Else
    ...
    If foundDuplicateReport Then
        ...
        If controlFile.Worksheets.Count = 1 Then
            controlFile.Worksheets("CEC " + sheetName + " Report").Name = "Null"
            Sheets.Add.Name = "CEC " + sheetName + " Report"
        ...
        Else
            ...
            Application.DisplayAlerts = False
            controlFile.Worksheets("CEC " + sheetName + " Report").Delete
            Application.DisplayAlerts = True
        End If
    End If
    ...
    If Not foundEmptyWorksheet Then
        If foundLCSLCSD Then
            Sheets.Add(Before:=controlFile.Worksheets("LCSLCSD " + sheetName + " Report")).Name = "CEC " + sheetName + " Report"
        Else
            Sheets.Add(Before:=controlFile.Worksheets(controlFile.Worksheets.Count)).Name = "CEC " + sheetName + " Report"
        End If
    End If
            ...
            With ProjectInfoTextBox
                ...
                If TextBoxPosition = "B14" Then
                    .Caption = "Client: " & ClientTextBox.Text & vbCrLf & _
                                ...
                                "Method: Contaminants of Emerging Concern Quantification"
                    .Font.Size = 13
                Else
    ...
    With controlFile.Worksheets("Glossary")
        ...
        .Range("D9").Value = "Contaminants of Emerging Concern"
    ...
    With controlFile.Worksheets("CEC " + sheetName + " Report")
        'Header Initialization
        With .PageSetup
            .CenterHeader = "&G"
            .CenterFooter = "&G"
        ...
        'Freeze columns
        controlFile.Worksheets("CEC " + sheetName + " Report").Activate
        With ActiveWindow
        ...
        'IDLList = Array(0.18, 0.32, 0.14, 0.04, 0.005, 0.09, 0.08, 0.23, 0.07, 0.003, 0.06, 0.01, 0.04, 0.01, 0.39, 0.08, 0.05, 0.03, 0.01, 0.17, 0.01, 0.11, 0.57, 0.18, 0.02, 0.05, 0.01, 0.02, 0.02, 0.11, 0.3, 0.01, 0.02, 0.01)
        'MDLList = Array(0.97, 1.04, 0.99, 0.9, 0.97, 0.82, 0.99, 0.99, 1, 0.97, 2.04, 0.62, 0.71, 0.78, 0.95, 0, 1.05, 1.03, 0.77, 0.89, 1.02, 5.3, 1.1, 0.94, 0.98, 0.95, 0.98, 0.94, 0.75, 1.01, 0.97, 1, 0.87)
        ...
        For Counter = 0 To analyteListLength - 1
            ...
            If MatrixComboBox.Value <> "" And SampleTextBox.Value <> "" Then
                ...
                '.Cells(analyteListStartingRow + counter, 4).Value = Round(IIf(IDLList(counter) < RLList(counter), IDLList(counter), RLList(counter)) * IIf(MatrixComboBox.Value = "Water", 1000 / (SampleTextBox.Value / 1), 1 / SampleTextBox.Value), 3)
                '.Cells(analyteListStartingRow + counter, 5).Value = Round(MDLList(counter) * IIf(MatrixComboBox.Value = "Water", 1000 / (SampleTextBox.Value / 1), 1 / SampleTextBox.Value), 3)
            End If
    ...
    For Each ws In ActiveWorkbook.Worksheets
        ...
        Else
            ...
            ws.PageSetup.ScaleWithDocHeaderFooter = False
            Application.ExecuteExcel4Macro ("Page.Setup(,,0.3,0.3,2.15,2.15,,,,,,,{#N/A,1},,,,,0.3,0.3,,)")
        End If
    Next ws
